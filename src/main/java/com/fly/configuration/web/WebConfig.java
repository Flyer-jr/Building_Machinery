...
public class WebConfig implements WebMvcConfigurer {
  ...
  public void addFormatters(FormatterRegistry registry) {
    ...
    registry.addConverter(
        new ConstructionSiteCreateRequestConverter(constructionSiteValidationService));
    registry.addConverter(
        new ConstructionSiteChangeRequestConverter(constructionSiteValidationService));
